...
<div id="layout_menu_module_div" class="wizard_main_divs">
	...
	<div class="hk-row-fluid">
		<div class="hkc-md-2 offsetdiv"></div>
		<div id="layout_products_menu" class="hkc-md-2 wizard_thumbnail" onclick="selectLayout(this, 'layout_menu_module','products_menu');">
		...
		<div class="hkc-md-1 offsetdiv"></div>
		<div id="layout_categories_menu" class="hkc-md-2 wizard_thumbnail" onclick="selectLayout(this, 'layout_menu_module','categories_menu');">
			<div class="wizard_thumbnail_img">
		...
		<div class="hkc-md-1 offsetdiv"></div>
		<div id="layout_categories_module" class="hkc-md-2 wizard_thumbnail" onclick="selectLayout(this, 'layout_menu_module','categories_module');">
			<div class="wizard_thumbnail_img">
...
<div id="layout_type_div" class="wizard_main_divs">
	...
	<div class="hk-row-fluid">
		<div class="hkc-md-2 offsetdiv"></div>
		<div id="layout_listing_div" class="hkc-md-2 wizard_thumbnail" onclick="selectLayout(this, 'layout_type','listing_div');">
			<div class="wizard_thumbnail_img">
		...
		<div class="hkc-md-1 offsetdiv"></div>
		<div id="layout_listing_list" class="hkc-md-2 wizard_thumbnail" onclick="selectLayout(this, 'layout_type','listing_list');">
			<div class="wizard_thumbnail_img">
		...
		<div class="hkc-md-1 offsetdiv"></div>
		<div id="layout_listing_table" class="hkc-md-2 wizard_thumbnail" onclick="selectLayout(this, 'layout_type','listing_table');">
			<div class="wizard_thumbnail_img">
...
<div class="wizard_main_divs">
	...
	<div class="hk-row-fluid">
		<div class="wizard_subdiv_left hkc-md-3">
			<img src="<?php echo HIKASHOP_IMAGES; ?>wizard/location.png" alt=""/>
		</div>
		<div class="wizard_subdiv_right hkc-md-9">
		<!-- ADDRESS -->
	...
	?>
				<dt><label for="address_state"><?php echo JText::_('STATE'); ?></label></dt>
				<dd><?php echo $this->fieldsClass->display($oneExtraField,@$this->address->address_state,'address_state',false,''); ?></dd>
	<?php
		}
	?>
...
<div class="wizard_main_divs">
	...
	<div class="hk-row-fluid">
		...
		<div class="wizard_subdiv_right hkc-md-9">
			...
			<div class="wizard_shop_tax">
				<dl>
					<dt>
						<label for="install_eu_taxes"><?php echo JText::_('WIZARD_INSTALL_EU_TAXES').': '; ?></label>
					</dt>
					<dd>
	...
	?>
					...
					<dd>
						...
						<em><?php echo JText::_('WIZARD_TAX_NAME_SAMPLE'); ?></em>
					</dd>
					<dt>
