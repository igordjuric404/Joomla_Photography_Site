...
<form action="<?php echo hikashop_completeLink('order',true); ?>" method="post"  name="adminForm" id="adminForm">
	...
	<input type="hidden" name="cart_id" value="<?php echo hikaInput::get()->getInt('cart_id','0');?>" />
	<input type="hidden" name="product_id" value="<?php echo hikaInput::get()->getInt('product_id','0');?>" />
