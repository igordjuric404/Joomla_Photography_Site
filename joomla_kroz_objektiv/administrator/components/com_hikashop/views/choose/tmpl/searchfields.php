...
<!--
	...
	function insertTag(){
		...
		window.top.document.getElementById('<?php echo $this->controlName; ?>fields').value = tag;
		window.top.document.getElementById('link<?php echo $this->controlName; ?>fields').href = 'index.php?option=com_hikashop&tmpl=component&ctrl=choose&task=searchfields&control=<?php echo $this->controlName; ?>&values='+tag;
		hikashop.closeBox();
	}
//-->
</script>
