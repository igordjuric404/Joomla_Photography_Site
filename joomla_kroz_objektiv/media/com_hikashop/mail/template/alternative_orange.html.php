...
h1 { text-align: center;color: #ea9802; border-bottom: 3px solid #ea9802 !important;}
h2 {color: #ea9802 !important; padding: 0px !important; margin-bottom: 0px; border-bottom: 1px solid #d6d6d6;}
...
div#title {
    ...
    background: -webkit-linear-gradient(left,#fe6000,#ea9802);
    background: -o-linear-gradient(right,#fe6000,#ea9802);
    background: -moz-linear-gradient(right,#fe6000,#ea9802);
    background: linear-gradient(to right,#fe6000,#ea9802);
}
