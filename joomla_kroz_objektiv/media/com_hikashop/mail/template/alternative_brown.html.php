...
h1 { text-align: center;color: #864e00; border-bottom: 3px solid #864e00 !important;}
h2 {color: #864e00 !important; padding: 0px !important; margin-bottom: 0px; border-bottom: 1px solid #d6d6d6;}
.hika_template_color {color:#864e00 !important;}
...
div#title {
    ...
    background-color: #962f00;
    background: -webkit-linear-gradient(left,#962f00,#864e00);
    background: -o-linear-gradient(right,#962f00,#864e00);
    background: -moz-linear-gradient(right,#962f00,#864e00);
    background: linear-gradient(to right,#962f00,#864e00);
}
