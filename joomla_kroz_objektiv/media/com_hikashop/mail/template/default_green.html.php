...
h1{color:#05c56c !important;font-size:16px;font-weight:bold;border-bottom:1px solid #ddd; padding-bottom:10px;}
h2{color:#05c56c !important;font-size:14px;font-weight:bold;margin-top:20px;margin-bottom:5px;border-bottom:1px solid #d6d6d6;padding-bottom:4px;}
.hika_template_color {color:#05c56c !important;}
	...
	<table class="w600" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:18px;margin:auto;background-color:#ebebeb;text-align:center;" border="0" cellspacing="0" cellpadding="0" width="600">
		<tr style="line-height: 0px;">
			<td class="w600" style="line-height:0px" width="600" valign="bottom">
				<img class="w600" src="{VAR:LIVE_SITE}media/com_hikashop/images/mail/header_green.png" border="0" alt="" />
			</td>
		</tr>
		<tr>
...
{VAR:TPL_CONTENT}
		...
		<tr style="line-height: 0px;">
			<td class="w600" style="line-height:0px" width="600" valign="top">
				<img class="w600" src="{VAR:LIVE_SITE}media/com_hikashop/images/mail/footer_green.png" border="0" alt="--" />
			</td>
		</tr>
	</table>
<!--{IF:TPL_FOOTER}-->
