...
h1 { text-align: center;color: #000; border-bottom: 3px solid #000 !important;}
h2 {color: #000 !important; padding: 0px !important; margin-bottom: 0px; border-bottom: 1px solid #d6d6d6;}
.hika_template_color {color:#000 !important;}
...
div#title {
    ...
    background-color: #656464;
    background: -webkit-linear-gradient(left,#656464,#000);
    background: -o-linear-gradient(right,#656464,#000);
    background: -moz-linear-gradient(right,#656464,#000);
    background: linear-gradient(to right,#656464,#000);
}
