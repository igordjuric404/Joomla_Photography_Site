...
h1 { text-align: center;color: #6f3bb3; border-bottom: 3px solid #6f3bb3 !important;}
h2 {color: #6f3bb3 !important; padding: 0px !important; margin-bottom: 0px; border-bottom: 1px solid #d6d6d6;}
.hika_template_color {color:#6f3bb3 !important;}
...
div#title {
    ...
    background-color: #4f39be;
    background: -webkit-linear-gradient(left,#4f39be,#6f3bb3);
    background: -o-linear-gradient(right,#4f39be,#6f3bb3);
    background: -moz-linear-gradient(right,#4f39be,#6f3bb3);
    background: linear-gradient(to right,#4f39be,#6f3bb3);
}
