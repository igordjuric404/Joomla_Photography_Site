...
h1{color:#8405c5 !important;font-size:16px;font-weight:bold;border-bottom:1px solid #ddd; padding-bottom:10px;}
h2{color:#8405c5 !important;font-size:14px;font-weight:bold;margin-top:20px;margin-bottom:5px;border-bottom:1px solid #d6d6d6;padding-bottom:4px;}
.hika_template_color {color:#8405c5 !important;}
a:visited{cursor:pointer;color:#2d9cbb;text-decoration:none;border:none;}
.cart_button.hika_template_color {
	color: #fff!important;
    font-size: 15px;
    font-weight: bold;
    background-color: #8405c5;
    border-radius: 5px;
    padding: 5px 10px;
}
a.cart_button.hika_template_color:hover {
    background-color: #5b0488;
	...
	<table class="w600" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:18px;margin:auto;background-color:#ebebeb;text-align:center;" border="0" cellspacing="0" cellpadding="0" width="600">
		<tr style="line-height: 0px;">
			<td class="w600" style="line-height:0px" width="600" valign="bottom">
				<img class="w600" src="{VAR:LIVE_SITE}media/com_hikashop/images/mail/header_purple.png" border="0" alt="" />
			</td>
		</tr>
		<tr>
...
{VAR:TPL_CONTENT}
		...
		<tr style="line-height: 0px;">
			<td class="w600" style="line-height:0px" width="600" valign="top">
				<img class="w600" src="{VAR:LIVE_SITE}media/com_hikashop/images/mail/footer_purple.png" border="0" alt="--" />
			</td>
		</tr>
	</table>
<!--{IF:TPL_FOOTER}-->
