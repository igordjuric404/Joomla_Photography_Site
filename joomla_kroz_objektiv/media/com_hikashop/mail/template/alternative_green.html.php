...
h1 { text-align: center;color: #56b986; border-bottom: 3px solid #56b986 !important;}
h2 {color: #56b986 !important; padding: 0px !important; margin-bottom: 0px; border-bottom: 1px solid #d6d6d6;}
.hika_template_color {color:#56b986 !important;}
...
div#title {
    ...
    background-color: #56af99;
    background: -webkit-linear-gradient(left,#56af99,#56b986);
    background: -o-linear-gradient(right,#56af99,#56b986);
    background: -moz-linear-gradient(right,#56af99,#56b986);
    background: linear-gradient(to right,#56af99,#56b986);
}
