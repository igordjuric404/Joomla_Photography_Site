...
?>
	...
	<tr>
		...
		<td id="shipping_services_list">
			<?php
					...
					$i=-1; foreach($this->data['canpar_methods'] as $method){
					$i++;
					$varName=$method['name'];
				?>
	...
	<tr>
		...
		<td>
			<label for="data[shipping][shipping_params][dim_approximation_l]"><?php echo JText::_( 'PRODUCT_LENGTH' ); ?></label> <input size="5" type="text" name="data[shipping][shipping_params][dim_approximation_l]" value="<?php echo @$this->element->shipping_params->dim_approximation_l; ?>" /> cm<br/><label for="data[shipping][shipping_params][dim_approximation_w]"><?php echo JText::_( 'PRODUCT_WIDTH' ); ?></label> <input size="5" type="text" name="data[shipping][shipping_params][dim_approximation_w]" value="<?php echo @$this->element->shipping_params->dim_approximation_w; ?>" /> cm<br/><label for="data[shipping][shipping_params][dim_approximation_h]"><?php echo JText::_( 'PRODUCT_HEIGHT' ); ?></label> <input size="5" type="text" name="data[shipping][shipping_params][dim_approximation_h]" value="<?php echo @$this->element->shipping_params->dim_approximation_h; ?>" /> cm<br/><?php echo JText::_( 'PRODUCT_WEIGHT' ); ?></label> <input size="5" type="text" name="data[shipping][shipping_params][dim_approximation_kg]" value="<?php echo @$this->element->shipping_params->dim_approximation_kg; ?>" /> KG
		</td>
	</tr>
	<tr>
		<td class="key">
