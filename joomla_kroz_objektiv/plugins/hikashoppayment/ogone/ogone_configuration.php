...
<tr>
	...
	<td>
		...
		$values[] = JHTML::_('select.option', 'test', 'KBC/CBC-Paypage DirectLink '.JText::_('HIKA_PRODUCTION'));
		$values[] = JHTML::_('select.option', 'test',  'KBC/CBC-Paypage DirectLink '.JText::_('HIKA_TEST'));
