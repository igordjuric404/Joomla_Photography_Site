...
$formName = ',0';
if(!$this->config->get('ajax_add_to_cart', 0) || ((int)$this->config->get('show_quantity_field') >= 2 && empty($this->element->product_id))) {
...
<?php
	...
	$max = (@$this->row->product_max_per_order || empty($this->element->main)) ? (int)@$this->row->product_max_per_order : (int)@$this->element->main->product_max_per_order;
	$min = (@$this->row->product_min_per_order || empty($this->element->main)) ? (int)@$this->row->product_min_per_order : (int)@$this->element->main->product_min_per_order;
	if($min <= 0)
		$min = 1;
	...
	if((int)$this->row->product_quantity == -1 && !empty($this->element->main) && (int)$this->element->main->product_quantity != -1)
		$this->row->product_quantity = (int)$this->element->main->product_quantity;
