...
class SppagebuilderAddonFeature extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		$addonBgStyle = $cssHelper->generateStyle('.sppb-addon.sppb-addon-feature', $settings, $addonProps, "");
		$css .= $addonBgStyle;
	...
	public static function getTemplate()
	{
		...
		<#
			...
			let feature_text  = \'<div id="addon-text-\'+data.id+\'" class="sppb-addon-text sp-editable-content" data-id="\'+data.id+\'" data-fieldName="text">\';
		...
		$output .= $lodash->color('background-color', '.sppb-addon.sppb-addon-feature', 'data.background_color');
